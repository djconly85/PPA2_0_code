...
# ========================================INPUT DATA LAYERS=====================================================
fgdb = r'D:\10Data\SACOG_PPA\Layers4ESRI.gdb'    #''I:\Projects\Darren\PPA_V2_GIS\PPA_V2.gdb' #for now, is reference only. individual scripts explicitly indicate workspace and file locations
...
accdata_fc = 'Sugar_access_data_latest'      #'Sugar_access_data_10072019_3backup' # sugar accessibility polygon data
...
aggvals_csv = r"D:\Projects\ApProjects\SACOGPPA\PPA2\PPA2\AggValCSVs\Agg_ppa_vals01132020_0954.csv"    #"Q:\ProjectLevelPerformanceAssessment\PPAv2\PPA2_0_code\PPA2\AggValCSVs\Agg_ppa_vals01132020_0954.csv"
...
template_dir = r'D:\Projects\ApProjects\SACOGPPA\PPA2\PPA2\ExcelTemplate'  #'Q:\ProjectLevelPerformanceAssessment\PPAv2\PPA2_0_code\PPA2\ExcelTemplate'
...
map_list_csv = r'D:\Projects\ApProjects\SACOGPPA\PPA2\PPA2\ExcelTemplate\map_report_key.csv'   #  "Q:\ProjectLevelPerformanceAssessment\PPAv2\PPA2_0_code\PPA2\ExcelTemplate\map_report_key.csv"
dir_pdf_output = arcpy.env.scratchFolder   #  r 'C:\TEMP'
