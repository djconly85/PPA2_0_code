...
def excel2pdf(in_xlsx, out_pdf, sheets_to_print):
    ...
    try:
        ...
        (name, ext) = os.path.splitext(in_xlsx)
        ...
        if(os.path.exists(out_pdf)):
            try:
                ...
                out_pdf = os.path.join(arcpy.env.scratchFolder, "xx{}.pdf".format(int(time.clock())))
        ...
        if(os.path.exists(out_pdf)):
            try:
                ...
                out_pdf = os.path.join(arcpy.env.scratchFolder, "r{}.pdf".format(int(time.clock())))
...
if __name__=='__main__':
    ...
    arcpy.SetParameterAsText(3, input_excel)
