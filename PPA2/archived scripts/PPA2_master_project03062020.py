...
if __name__ == '__main__':    
    ...
    arcpy.AddMessage(params.accdata_fc)
    ...
    output_xl = 'PPA_{}{}.xlsx'.format(os.path.basename(proj_name), time_sufx)  # 'PPA_{}{}.xlsm'.format(os.path.basename(proj_name), time_sufx)  # 
    ...
    if out_status == params.msg_ok:
        ...
        # arcpy.SetParameterAsText(8, "NOT_AVAILABLE") # don't allow bad PDF link to show to user.
        arcpy.SetParameterAsText(9, out_excel)
