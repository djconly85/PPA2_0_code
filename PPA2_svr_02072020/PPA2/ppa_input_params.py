...
fgdb = os.path.join(server_folder, 'PPA_V2.gdb')
...
"""
# dict with spaces removed. should be able to delete, if the version with spaces works.
perf_outcomes_dict = {'ReduceVMT': '1ReduceVMT', 
                      'ReduceCongestion': '2ReduceCongestion',
                      'EncourageMultimodalTravel': '3Multimodal',
                      'PromoteEconomicProsperity': '4EconProsperity',
                      'ImproveFreightMobility': '5Freight',
                      'MakeaSaferTransportationSystem': '6Safety',
                      'PromoteCompleteStreetsandStateofGoodRepair': '7SGR'
                      }
"""
...
sheets_all_reports = ['0ATitlePg', '0BUsingThisReport','8SocioEconEquity']

map_list_csv = os.path.join(server_folder, r"PPA2\Input_Template\CSV\map_report_key.csv")
